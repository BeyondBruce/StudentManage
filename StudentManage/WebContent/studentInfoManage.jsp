	...
	<table id="dg" title="学生信息" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="data" width="100" align="center">时间</th>
				<th field="java" width="100" align="center">java</th>
				<th field="javaweb" width="100" align="center">javaweb</th>
				<th field="android" width="100" align="center">android</th>
				<th field="English" width="100" align="center">English</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;学号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo"
				...
				id="s_stuName" size="10" /> &nbsp;所属班级：&nbsp;<input
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					...
					<td>时间：</td>
					<td><input class="easyui-datebox" name="data" id="data"
						required="true" editable="false" /></td>
				</tr>
				<tr>
					<td>java：</td>
					<td><input type="text" name="java" id="java"
						class="easyui-validatebox" required="true" /></td>
					
					<td>javaweb：</td>
					<td><input type="text" name="javaweb" id="javaweb"
						class="easyui-validatebox" required="true" /></td>
				</tr>
				<tr>
					
					<td>android</td>
					<td><input type="text" name="android" id="android"
						class="easyui-validatebox" required="true" /></td>
